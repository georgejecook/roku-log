...
#### [v0.11.1](https://github.com/georgejecook/roku-log/compare/v0.11.0...v0.11.1)

- add release job [`#49`](https://github.com/georgejecook/roku-log/pull/49)
- build: remove release-please, add release-it [`#48`](https://github.com/georgejecook/roku-log/pull/48)
- manual release process [`cd16571`](https://github.com/georgejecook/roku-log/commit/cd16571ae076c1baa61f0bf4fb545918b81c7637)
- fix: dry runs [`49d17c4`](https://github.com/georgejecook/roku-log/commit/49d17c4a40d76ae4e82b3c7a69838183f4a256c3)
- fix(build): fixes build hanging [`450b795`](https://github.com/georgejecook/roku-log/commit/450b7951a35bc9a35668e480b7ca83d7ee1b8d4f)
